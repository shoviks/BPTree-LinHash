...
class MovieDB
{
    ...
    public static void main (String [] args)
    {
        ...
        out.println ();
        Table t_indexed_join = movie.indexedJoin ("studioName", "name", studio);
        t_indexed_join.print ();

        out.println ();
        Table t_indexed_join2 = movie.indexedJoin ("title year", "title year", cinema);
        t_indexed_join2.print ();
